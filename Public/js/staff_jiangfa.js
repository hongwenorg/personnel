...
function prov_change() {
    ...
    if (sel.value == "shape") {
        opt = opt + '<option value="奖励">奖励</option><option value="处罚">处罚</option>';
    }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for(var aa=0;aa<tab_child.length;aa++){
                ...
                if(tab_child[aa].innerText==="奖罚记录"){
...
function ArrSort(page, num, content) {
    ...
    for (var j = page * PageSize; j < len; j++) {
            ...
            tb.appendChild(tr).innerHTML =
                ...
                "<td class='td_sty'>" + "<div name='" + arr_staff[j].user + "' class='div_inner'>" + arr_staff[j].shape + "</div>" + "<input type='hidden' class='shape_sort' value='" + 1 + "'></td>" +
                ...
                "<td class='td_sty'>" + "<div name='" + arr_staff[j].user + "' class='div_inner'>" + arr_staff[j].result + "</div>" + "<input type='hidden' class='result_sort' value='" + 1 + "'></td>" +
                "<td class='td_sty'>" + "<div name='" + arr_staff[j].user + "' class='div_inner'>" + arr_staff[j].reason + "</div>" + "<input type='hidden' class='reason_sort' value='" + 1 + "'></td>";
